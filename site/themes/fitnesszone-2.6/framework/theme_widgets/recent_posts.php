	...
	function widget($args, $instance) {
		...
		echo "<div class='recent-posts-widget'><ul>";
			 ...
			 while($the_query->have_posts()):
				...
				echo "<li>";
					...
					echo '<div class="entry-metadata">';
						echo '<p class="author"> <span class="fa fa-user"> </span> '.__('Postado por: ', 'iamd_text_domain').'<a href="'.get_author_posts_url(get_the_author_meta('ID')).'">'.get_the_author_meta('display_name').'</a></p>';
						$commtext = "";
			 ...
			 endwhile;
			 	...
			 	echo "<li><h4>".__('Post não encontrado','iamd_text_domain')."</h4></li>";
			 endif;
			 wp_reset_postdata();
	 	echo "</ul></div>";
		echo $after_widget;
